          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden">
            <div className="p-4 lg:p-8">
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-full overflow-hidden border border-accent/20 bg-gradient-to-br from-accent/20 to-accent/30 flex items-center justify-center">
                  <div className="text-accent font-bold text-lg">
                    {currentData?.name?.split(' ').map(n => n[0]).join('').toUpperCase() || 'LC'}
                  </div>
                </div>
